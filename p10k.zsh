# Generated by Powerlevel10k configuration wizard on 2019-08-01 at 15:20 MSK.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 18812.
# Wizard options: nerdfont-complete + powerline, large icons, classic, light,
# angled separators, sharp heads, blurred tails, 2 lines, solid, full frame, sparse,
# many icons, concise.
